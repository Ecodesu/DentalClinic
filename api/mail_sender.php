...
if($request_type == 'verification')
{
  ...
  else
  {
    ...
    $message .= '<div style = "max-width: 550px; margin: 0 20px; background: white; box-shadow: 0px 3px 5px 0px rgb(0 0 0 / 10%); padding: 40px 40px; border-radius: 50px; height:70%; ">';
