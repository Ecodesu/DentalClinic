...
if($request_type == 'verification')
{
  ...
  else
  {
    ...
    $message .= "<div class="container" style = " max-width: 550px; margin: 0 20px; background: white; box-shadow: 0 5px 10px rgba(0, 0, 0, 0.2); padding: 40px 40px; border-radius: 12px;">";
